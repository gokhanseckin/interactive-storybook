/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/cloudflare/wrangler.jsonc services/cloudflare/worker-configuration.d.ts` (hash: f793788274de0cc6030a27948ac809af)
...
interface __BaseEnv_Env {
	...
	ORIGIN: "https://staging.invalid" | "https://production.invalid" | "http://localhost:8787";
	ENABLE_PAID_GENERATION: "false";
	GENERATION: Workflow<Parameters<import("./src/index").NarrationWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ORIGIN" | "ENABLE_PAID_GENERATION">> {}
}
